...
[role="lead"]
También hay documentación disponible para versiones anteriores a la versión 5,2 del plugin de NetApp Element para VMware vCenter Server.


NOTE: Este link:index.html["enlace a la documentación"] Para el plugin de vCenter 5,2 de Element también incluye las versiones 5,1, 5,0, 4,10, 4,9, 4,8, 4,7 y 4,6.
