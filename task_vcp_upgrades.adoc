...
[role="lead"]
Si desea actualizar el plugin de NetApp Element para vCenter Server, siga los pasos que se describen para la instalación. El complemento NetApp Element vCenter 5,4 está disponible fuera de las versiones de Element y NetApp HCI como parte de un paquete de servicios de gestión.
