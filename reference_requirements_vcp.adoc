...
Para vCenter Server 8.0 y 7.0, puede <<create_vcp_role,Cree el "rol VCP" en vCenter>> En el caso de una cuenta de usuario del plugin de Element y de asignar permisos para registrar o actualizar el plugin de Element para vCenter Server y ejecutar tareas de administración del plugin de Element.
